...
//        let label = cityViewController.view.subviews[1] as! UILabel  // why 1?
//        label.text = "sunghoon"
//        print("scene의 생성자")
    ...
    func sceneDidBecomeActive(_ scene: UIScene) {
        ...
        let tabBarControler = window?.rootViewController as! UITabBarController
        let cityViewController = (tabBarControler.viewControllers?[0])! as! CityViewController
